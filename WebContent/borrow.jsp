...
<div class="container">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
               <li>
	            ...
	            <li>
	                 <a href="/books/borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 收藏信息</a>
	                </li>
	                <li>
	                    <a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 收藏历史</a>
	                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">收藏信息</div>
                            </div>
  ...
  %>                 
                            	<tr>
	                               ...
	                               <td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">取消收藏</button>
	                              </td>                                               
                          	  </tr>
                             <%} 
                             %>  
