...
<%@ page import = "com.rain.bean.AdminBean,com.rain.bean.HistoryBean,com.rain.bean.BookBean,com.rain.dao.BookDao,com.rain.dao.AdminDao" %>
            ...
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i>     欢迎您，<%=session.getAttribute("username") %><i class="caret"></i></a>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
               <li>
                    <a href="/books/selectServlet"><i class="glyphicon glyphicon-chevron-right"></i> 房源查询</a>
                </li>
	            <li>
	                 <a href="/books/borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 订阅信息</a>
	                </li>
	                <li>
	                    <a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 订阅历史</a>
	                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">订阅信息</div>
                            </div>
  ...
  %>                 
                            	<tr>
	                         	   	...
	                         	   	<td><%= bean.getArea() %></td>
	                                <td><%= bean.getPrice() %></td>
	                                <td><a href="<%= bean.getLinks() %>">直达链接</a></td>
	                               <td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">取消订阅</button>
	                              </td>                                               
                          	  </tr>
                             <%} 
                             %>  
 ...
 <%-- <%
                           ...
                           if(bookdata==null){
                        	   BookDao bookdao = new BookDao();
                        	   bookdata = (ArrayList<BookBean>)bookdao.get_ListInfo0(1);
                           }
  ...
  %>                 
								<tbody>
	                                ...
	                                <td><%= bean.getNum() %></td>
 									<td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getBid() %>)">取消订阅</button>
	                                </td>                                           
